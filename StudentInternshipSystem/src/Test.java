...
public class Test {
    public static void main(String[] args) {
        // WARNING: DON'T CHANGE ANYTHING IN THIS FILE. ONLY RUN WITH REQUIRED ARGUMENTS AND SEE YOUR SCORE!

        String outputFilepath = args[0];
        String expectedOutputFilepath = args[1];

        double score = testOutputFile(outputFilepath, expectedOutputFilepath);
